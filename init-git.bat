@echo off
REM Script para inicializar o repositório Git e fazer primeiro push
REM Abra este arquivo com um editor de texto e substitua SEU-USERNAME por seu usuário do GitHub
...
echo 2. Copie o comando abaixo (substitua SEU-USERNAME e REPO-NAME):
echo.
